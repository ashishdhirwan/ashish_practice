...
events.on("push", async () => {
  ...
  j.tasks = [
   ...
   // "git init",
    ...
    "docker build -t dhirwanashish/tag_version:latest .",
    "echo done-build",
    "docker tag dhirwanashish/tag_version:latest gcr.io/my-project-70505/dhirwanashish/tag_version:$latestTag",
    "echo done-tagging",
    "docker push gcr.io/my-project-70505/dhirwanashish/tag_version:$latestTag",
    "ls -lart",
    "echo $(pwd)",
    "ls -lart",
    "helm init",
